/*  PolyMask.js - Cross Browser JS Element Masking
* USAGE: jQuery('.masked').polyMask();
*        Use data-mask-path attribute to element. Path needs to be devided by 100
Bugs:
please use px unit for absolute path (not responsive %)
if responsive dont put %
*/
;(function ( $ ) {
